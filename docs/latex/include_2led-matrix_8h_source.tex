...
\hypertarget{include_2led-matrix_8h_source}{}\label{include_2led-matrix_8h_source}\index{include/led-\/matrix.h@{include/led-\/matrix.h}}
\mbox{\hyperlink{include_2led-matrix_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00051\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix}{RGBMatrix}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classrgb__matrix_1_1Canvas}{Canvas}}\ \{}
...
\DoxyCodeLine{00055\ \ \ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structrgb__matrix_1_1RGBMatrix_1_1Options}{Options}}\ \{}
...
\DoxyCodeLine{00167\ \ \ \textcolor{keyword}{static}\ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix}{RGBMatrix}}\ *\mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix_a6394234632895f9da0db72ef869343a4}{CreateFromOptions}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{structrgb__matrix_1_1RGBMatrix_1_1Options}{Options}}\ \&options,}
...
\DoxyCodeLine{00186\ \ \ \textcolor{keyword}{static}\ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix}{RGBMatrix}}\ *\mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix_aaf6a3fcdd884d79f0ffec9265ee12bfa}{CreateFromFlags}}(\textcolor{keywordtype}{int}\ *argc,\ \textcolor{keywordtype}{char}\ ***argv,}
...
\DoxyCodeLine{00192\ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix_a51f1f731ba2b9e548efb6e03d65e5878}{\string~RGBMatrix}}();}
\DoxyCodeLine{00193\ }
...
\DoxyCodeLine{00200\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix_a1dbc3704fadf38ba8fcdc7ec7d5fcc84}{width}}()\ \textcolor{keyword}{const};}
\DoxyCodeLine{00201\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix_ad65cc78e6460676478e624c5d6452ebf}{height}}()\ \textcolor{keyword}{const};}
\DoxyCodeLine{00202\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix_a66e85ad96e796c64224026ebdb47e221}{SetPixel}}(\textcolor{keywordtype}{int}\ x,\ \textcolor{keywordtype}{int}\ y,}
\DoxyCodeLine{00203\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ uint8\_t\ red,\ uint8\_t\ green,\ uint8\_t\ blue);}
\DoxyCodeLine{00204\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix_aeed942257c6634ef6c488d2790b54f23}{Clear}}();}
\DoxyCodeLine{00205\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix_ab2986691a842d4693bb11cf04741ae5b}{Fill}}(uint8\_t\ red,\ uint8\_t\ green,\ uint8\_t\ blue);}
\DoxyCodeLine{00206\ }
...
\DoxyCodeLine{00330\ \ \ \textcolor{keyword}{class\ }Impl;}
\DoxyCodeLine{00331\ }
\DoxyCodeLine{00332\ \ \ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix}{RGBMatrix}}(Impl\ *impl)\ :\ impl\_(impl)\ \{\}}
\DoxyCodeLine{00333\ \ \ Impl\ *\textcolor{keyword}{const}\ impl\_;}
\DoxyCodeLine{00334\ \};}
\DoxyCodeLine{00335\ }
\DoxyCodeLine{00336\ \textcolor{keyword}{namespace\ }internal\ \{}
\DoxyCodeLine{00337\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classrgb__matrix_1_1internal_1_1Framebuffer}{Framebuffer}};}
\DoxyCodeLine{00338\ \}}
\DoxyCodeLine{00339\ }
\DoxyCodeLine{00340\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classrgb__matrix_1_1FrameCanvas}{FrameCanvas}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classrgb__matrix_1_1Canvas}{Canvas}}\ \{}
...
\DoxyCodeLine{00381\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classrgb__matrix_1_1FrameCanvas_ab6a4de84a8668af8cfd26ae97721ae9f}{width}}()\ \textcolor{keyword}{const};}
\DoxyCodeLine{00382\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classrgb__matrix_1_1FrameCanvas_a1a062dd225d1bc25c333fe1324f968d2}{height}}()\ \textcolor{keyword}{const};}
\DoxyCodeLine{00383\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1FrameCanvas_a886731b3147fd33b101fda1e147d5cb6}{SetPixel}}(\textcolor{keywordtype}{int}\ x,\ \textcolor{keywordtype}{int}\ y,}
\DoxyCodeLine{00384\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ uint8\_t\ red,\ uint8\_t\ green,\ uint8\_t\ blue);}
\DoxyCodeLine{00385\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1FrameCanvas_af398c504a8b7ee6fe136ec091af844d7}{SetPixels}}(\textcolor{keywordtype}{int}\ x,\ \textcolor{keywordtype}{int}\ y,\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classrgb__matrix_1_1FrameCanvas_ab6a4de84a8668af8cfd26ae97721ae9f}{width}},\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classrgb__matrix_1_1FrameCanvas_a1a062dd225d1bc25c333fe1324f968d2}{height}},}
\DoxyCodeLine{00386\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structrgb__matrix_1_1Color}{Color}}\ *colors);}
\DoxyCodeLine{00387\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1FrameCanvas_ab7001820603143d6dc4e6d6820ecfb2d}{Clear}}();}
\DoxyCodeLine{00388\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1FrameCanvas_aeba684d23ac57c9d44e6910d81fc4360}{Fill}}(uint8\_t\ red,\ uint8\_t\ green,\ uint8\_t\ blue);}
\DoxyCodeLine{00389\ }
...
\DoxyCodeLine{00402\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structrgb__matrix_1_1RuntimeOptions}{RuntimeOptions}}\ \{}
...
\DoxyCodeLine{00507\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classrgb__matrix_1_1RGBMatrix}{RGBMatrix}}\ *\mbox{\hyperlink{namespacergb__matrix_a812ef557db4a55bfb0fbbb6c10ccdc1b}{CreateMatrixFromFlags}}(}
\DoxyCodeLine{00508\ \ \ \textcolor{keywordtype}{int}\ *argc,\ \textcolor{keywordtype}{char}\ ***argv,}
\DoxyCodeLine{00509\ \ \ \mbox{\hyperlink{structrgb__matrix_1_1RGBMatrix_1_1Options}{RGBMatrix::Options}}\ *default\_options\ =\ NULL,}
\DoxyCodeLine{00510\ \ \ \mbox{\hyperlink{structrgb__matrix_1_1RuntimeOptions}{RuntimeOptions}}\ *default\_runtime\_opts\ =\ NULL,}
