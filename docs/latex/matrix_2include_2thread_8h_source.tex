...
\hypertarget{matrix_2include_2thread_8h_source}{}\label{matrix_2include_2thread_8h_source}\index{matrix/include/thread.h@{matrix/include/thread.h}}
\mbox{\hyperlink{matrix_2include_2thread_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00024\ \textcolor{keyword}{class\ }Thread\ \{}
...
\DoxyCodeLine{00029\ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{classrgb__matrix_1_1Thread_ad0dbe8f790f4684b68d37d385dda38a7}{\string~Thread}}();}
\DoxyCodeLine{00030\ }
...
\DoxyCodeLine{00041\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1Thread_afd078ad5548630ee924768d42093e1f2}{Start}}(\textcolor{keywordtype}{int}\ realtime\_priority\ =\ 0,\ uint32\_t\ cpu\_affinity\_mask\ =\ 0);}
\DoxyCodeLine{00042\ }
