...
\hypertarget{matrix_2include_2content-streamer_8h_source}{}\label{matrix_2include_2content-streamer_8h_source}\index{matrix/include/content-\/streamer.h@{matrix/include/content-\/streamer.h}}
\mbox{\hyperlink{matrix_2include_2content-streamer_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00030\ \textcolor{keyword}{class\ }StreamIO\ \{}
...
\DoxyCodeLine{00048\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classrgb__matrix_1_1FileStreamIO_a59b541b989afb3ebc599ff33353f996d}{FileStreamIO}}(\textcolor{keywordtype}{int}\ fd);}
\DoxyCodeLine{00049\ \ \ \mbox{\hyperlink{classrgb__matrix_1_1FileStreamIO_a3c7e1a7af969abe7f1ae6c70028c4e9e}{\string~FileStreamIO}}();}
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00051\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1FileStreamIO_a7fa47c6991fed4981dc7d0f82d743759}{Rewind}}()\ final;}
\DoxyCodeLine{00052\ \ \ ssize\_t\ \mbox{\hyperlink{classrgb__matrix_1_1FileStreamIO_a6958207eaa0db975b1bf29026b8c2c5d}{Read}}(\textcolor{keywordtype}{void}\ *buf,\ \textcolor{keywordtype}{size\_t}\ count)\ final;}
\DoxyCodeLine{00053\ \ \ ssize\_t\ \mbox{\hyperlink{classrgb__matrix_1_1FileStreamIO_aed737e26d15e2522949c97c08a850cdf}{Append}}(const\ \textcolor{keywordtype}{void}\ *buf,\ \textcolor{keywordtype}{size\_t}\ count)\ final;}
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ private:}
\DoxyCodeLine{00056\ \ \ const\ \textcolor{keywordtype}{int}\ fd\_;}
\DoxyCodeLine{00057\ \};}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \textcolor{comment}{//\ Storing\ a\ stream\ in\ memory.\ Owns\ the\ memory.}}
\DoxyCodeLine{00060\ class\ \mbox{\hyperlink{classrgb__matrix_1_1MemStreamIO}{MemStreamIO}}\ :\ public\ \mbox{\hyperlink{classrgb__matrix_1_1StreamIO}{StreamIO}}\ \{}
\DoxyCodeLine{00061\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00062\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classrgb__matrix_1_1MemStreamIO_a14e2b75659905161332331b58aead39f}{Rewind}}()\ final;}
\DoxyCodeLine{00063\ \ \ ssize\_t\ \mbox{\hyperlink{classrgb__matrix_1_1FileStreamIO_a6958207eaa0db975b1bf29026b8c2c5d}{Read}}(\textcolor{keywordtype}{void}\ *buf,\ \textcolor{keywordtype}{size\_t}\ count)\ final;}
\DoxyCodeLine{00064\ \ \ ssize\_t\ \mbox{\hyperlink{classrgb__matrix_1_1FileStreamIO_aed737e26d15e2522949c97c08a850cdf}{Append}}(const\ \textcolor{keywordtype}{void}\ *buf,\ \textcolor{keywordtype}{size\_t}\ count)\ final;}
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ private:}
\DoxyCodeLine{00067\ \ \ std::\textcolor{keywordtype}{string}\ buffer\_;\ \ \textcolor{comment}{//\ super\ simplistic.}}
...
\DoxyCodeLine{00072\ class\ \mbox{\hyperlink{classrgb__matrix_1_1MemMapViewInput}{MemMapViewInput}}\ :\ public\ \mbox{\hyperlink{classrgb__matrix_1_1StreamIO}{StreamIO}}\ \{}
\DoxyCodeLine{00073\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00074\ \ \ \mbox{\hyperlink{classrgb__matrix_1_1MemMapViewInput_a8859cfe9b3e36443743c72cdb460f0ec}{MemMapViewInput}}(\textcolor{keywordtype}{int}\ fd);}
...
\DoxyCodeLine{00081\ \ \ ssize\_t\ \mbox{\hyperlink{classrgb__matrix_1_1FileStreamIO_a6958207eaa0db975b1bf29026b8c2c5d}{Read}}(\textcolor{keywordtype}{void}\ *buf,\ \textcolor{keywordtype}{size\_t}\ count)\ final;}
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00083\ \ \ \textcolor{comment}{//\ No\ append,\ this\ is\ purely\ read-\/only.}}
\DoxyCodeLine{00084\ \ \ ssize\_t\ \mbox{\hyperlink{classrgb__matrix_1_1FileStreamIO_aed737e26d15e2522949c97c08a850cdf}{Append}}(const\ \textcolor{keywordtype}{void}\ *buf,\ \textcolor{keywordtype}{size\_t}\ count)\ final\ \{\ \textcolor{keywordflow}{return}\ -\/1;\ \}}
\DoxyCodeLine{00085\ }
...
\DoxyCodeLine{00090\ \};}
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00092\ \textcolor{keyword}{class\ }StreamWriter\ \{}
\DoxyCodeLine{00093\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00094\ \ \ \textcolor{comment}{//\ Does\ not\ take\ ownership\ of\ StreamIO}}
\DoxyCodeLine{00095\ \ \ \mbox{\hyperlink{classrgb__matrix_1_1StreamWriter_a83e2bddd9cd51f9142dc5a2a76cb75fe}{StreamWriter}}(\mbox{\hyperlink{classrgb__matrix_1_1StreamIO}{StreamIO}}\ *io);}
\DoxyCodeLine{00096\ }
...
\DoxyCodeLine{00111\ \ \ \mbox{\hyperlink{classrgb__matrix_1_1StreamReader_a55b7c971e3209ab9a917f8e775520608}{StreamReader}}(\mbox{\hyperlink{classrgb__matrix_1_1StreamIO}{StreamIO}}\ *io);}
